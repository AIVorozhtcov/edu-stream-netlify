<template>
  <div class="flex flex-column pb-5">
      ...
      <div :class="[this.$store.getters['getIsMobile'] ? 'mobile-ignore-global-margins' : 'ignore-global-margins', 'relative flex h-fit']">   
        ...
        <img :class="[this.$store.getters['getIsMobile'] ? 'mobile-welcome-image' : 'w-full h-3/4']"  :src="[this.$store.getters['getIsMobile'] ? italianCoursesWelcome : italianCoursesWelcome]">            
    </div>      
