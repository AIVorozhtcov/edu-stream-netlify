  ...
  <div class="flex flex-column">
    <div class="relative flex h-fit ignore-global-margins">   
        <div class="absolute flex flex-column" style=" margin-left:21%; margin-top:20%">         
          <div class="h-fit text-black mb-4 font-extrabold" style="font-size: calc(6px + 2.450625vw);" v-html="$t('courses.italian.image_title')"></div>
          <div class="h-fit text-black mb-4 font-bold" style="font-size: calc(2px + 1.150625vw);" v-html="$t('courses.italian.image_subtitle')"></div>
